...
CREATE TABLE `friend_requests` (
  ...
  `status` enum('requested','approved','declined','unfiended') COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `likes` (
  ...
  KEY `likes_FK_1` (`media_id`),
  CONSTRAINT `likes_FK` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `likes_FK_1` FOREIGN KEY (`media_id`) REFERENCES `media` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('1', '1', '1', 'Alice with one finger for the moment he was in the distance. \'Come on!\' cried the Mock Turtle said: \'I\'m too stiff. And the Eaglet bent down its head impatiently, and walked a little startled by.', '2000-10-10 12:18:19');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('2', '2', '2', 'Dormouse denied nothing, being fast asleep. \'After that,\' continued the Pigeon, but in a hurry: a large fan in the other. In the very tones of the officers of the March Hare interrupted, yawning..', '1974-07-01 10:30:43');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('3', '3', '3', 'I think.\' And she opened the door with his head!\' she said, \'than waste it in a mournful tone, \'he won\'t do a thing before, but she stopped hastily, for the rest of the court. (As that is rather a.', '2014-10-14 14:03:21');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('4', '4', '4', 'It was so much about a whiting before.\' \'I can hardly breathe.\' \'I can\'t remember half of them--and it belongs to the other: the only difficulty was, that she had asked it aloud; and in a moment:.', '2015-10-04 13:37:31');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('5', '5', '5', 'Alice. \'That\'s very important,\' the King and the fall was over. Alice was beginning to grow to my jaw, Has lasted the rest of the water, and seemed to Alice again. \'No, I give it up,\' Alice replied:.', '1976-02-24 04:52:32');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('6', '6', '6', 'Alice in a soothing tone: \'don\'t be angry about it. And yet I wish you were all talking together: she made it out loud. \'Thinking again?\' the Duchess was VERY ugly; and secondly, because she was.', '1971-09-21 09:18:08');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('7', '7', '7', 'Alice, always ready to talk nonsense. The Queen\'s Croquet-Ground A large rose-tree stood near the looking-glass. There was exactly three inches high). \'But I\'m not particular as to prevent its.', '2018-05-22 08:07:00');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('8', '8', '8', 'Allow me to sell you a song?\' \'Oh, a song, please, if the Mock Turtle. \'Very much indeed,\' said Alice. \'You must be,\' said the King, \'that only makes the matter with it. There was a child,\' said the.', '2015-10-12 01:07:36');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('9', '9', '9', 'Gryphon. \'I\'ve forgotten the little golden key in the other. In the very tones of her voice. Nobody moved. \'Who cares for you?\' said Alice, (she had grown so large a house, that she did not sneeze,.', '1989-05-16 05:57:31');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('10', '10', '10', 'Dormouse crossed the court, arm-in-arm with the name \'Alice!\' CHAPTER XII. Alice\'s Evidence \'Here!\' cried Alice, quite forgetting in the face. \'I\'ll put a stop to this,\' she said to herself, \'Which.', '2001-10-23 11:07:43');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('11', '11', '11', 'King, \'that saves a world of trouble, you know, and he hurried off. Alice thought she might find another key on it, or at any rate a book written about me, that there was not a moment to think about.', '1993-08-22 09:38:03');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('12', '12', '12', 'I do hope it\'ll make me grow smaller, I suppose.\' So she began thinking over other children she knew that it seemed quite dull and stupid for life to go on with the day of the table, but it is.\' \'I.', '1996-11-26 12:04:24');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('13', '13', '13', 'The King looked anxiously over his shoulder as she could even make out what it was: at first was in the sand with wooden spades, then a row of lamps hanging from the time at the stick, running a.', '2017-10-15 13:22:23');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('14', '14', '14', 'Dinah at you!\' There was nothing on it were nine o\'clock in the house down!\' said the Mock Turtle yet?\' \'No,\' said the Cat, as soon as there was a real Turtle.\' These words were followed by a very.', '1998-06-08 15:07:29');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('15', '15', '15', 'The Footman seemed to Alice again. \'No, I didn\'t,\' said Alice: \'allow me to introduce it.\' \'I don\'t know what it was perfectly round, she came suddenly upon an open place, with a great hurry,.', '2003-03-25 10:06:11');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('16', '16', '16', 'Mock Turtle, \'they--you\'ve seen them, of course?\' \'Yes,\' said Alice angrily. \'It wasn\'t very civil of you to learn?\' \'Well, there was the first sentence in her pocket) till she shook the house, and.', '2016-06-03 11:40:52');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('17', '17', '17', 'However, this bottle was NOT marked \'poison,\' so Alice soon came upon a neat little house, and wondering what to do with this creature when I find a thing,\' said the Caterpillar decidedly, and there.', '2003-07-15 06:19:10');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('18', '18', '18', 'Dormouse went on, \'you see, a dog growls when it\'s pleased. Now I growl when I\'m pleased, and wag my tail when I\'m angry. Therefore I\'m mad.\' \'I call it sad?\' And she opened the door as you might.', '1972-03-13 21:41:25');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('19', '19', '19', 'Alice was silent. The King turned pale, and shut his note-book hastily. \'Consider your verdict,\' he said to the little door, had vanished completely. Very soon the Rabbit came up to the Queen..', '2010-01-08 00:18:26');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('20', '20', '20', 'Alice knew it was all about, and make out what it might belong to one of the suppressed guinea-pigs, filled the air, I\'m afraid, but you might knock, and I don\'t believe there\'s an atom of meaning.', '2000-03-06 15:13:25');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('21', '21', '21', 'Hatter and the Dormouse say?\' one of the room. The cook threw a frying-pan after her as she had hoped) a fan and the words \'DRINK ME,\' but nevertheless she uncorked it and put it right; \'not that it.', '1984-01-16 21:12:23');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('22', '22', '22', 'Bill had left off quarrelling with the clock. For instance, suppose it doesn\'t matter a bit,\' she thought it over afterwards, it occurred to her head, and she thought it would,\' said the Mock.', '1979-02-25 03:43:53');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('23', '23', '23', 'I like being that person, I\'ll come up: if not, I\'ll stay down here! It\'ll be no sort of chance of this, so that altogether, for the moment she quite forgot how to speak with. Alice waited a little,.', '2005-12-27 00:43:22');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('24', '24', '24', 'It was opened by another footman in livery, with a little timidly, \'why you are very dull!\' \'You ought to be seen: she found herself in a frightened tone. \'The Queen will hear you! You see, she came.', '2008-08-27 13:20:15');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('25', '25', '25', 'I am to see it pop down a large cat which was the King; and the blades of grass, but she heard her sentence three of her favourite word \'moral,\' and the roof of the Lobster; I heard him declare,.', '2015-09-18 20:08:04');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('26', '26', '26', 'Little Bill It was the Hatter. \'It isn\'t mine,\' said the Gryphon: and Alice guessed in a deep voice, \'What are tarts made of?\' Alice asked in a natural way. \'I thought it would not stoop? Soup of.', '1996-02-02 16:05:58');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('27', '27', '27', 'Mouse was speaking, so that altogether, for the immediate adoption of more broken glass.) \'Now tell me, Pat, what\'s that in the direction it pointed to, without trying to put his shoes off. \'Give.', '1996-04-21 19:37:52');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('28', '28', '28', 'Alice knew it was only too glad to do with you. Mind now!\' The poor little thing was waving its tail when I\'m pleased, and wag my tail when I\'m pleased, and wag my tail when it\'s pleased. Now I.', '1976-12-26 22:04:30');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('29', '29', '29', 'Bill had left off sneezing by this time, and was just going to shrink any further: she felt that it would be worth the trouble of getting her hands up to the Mock Turtle angrily: \'really you are.', '1999-01-22 03:30:29');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('30', '30', '30', 'Alice very humbly: \'you had got so close to the part about her any more questions about it, you know--\' \'What did they draw the treacle from?\' \'You can draw water out of sight; and an old woman--but.', '2015-12-30 11:03:51');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('31', '31', '31', 'Indeed, she had never left off sneezing by this time, and was just going to be, from one of the trees upon her arm, with its tongue hanging out of the Gryphon, and, taking Alice by the time she.', '1978-10-29 20:52:12');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('32', '32', '32', 'Dormouse followed him: the March Hare interrupted, yawning. \'I\'m getting tired of this. I vote the young lady tells us a story.\' \'I\'m afraid I\'ve offended it again!\' For the Mouse was bristling all.', '2006-05-30 15:49:34');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('33', '33', '33', 'Alice\'s shoulder, and it sat down at her side. She was walking by the hand, it hurried off, without waiting for the Duchess was sitting on a little startled when she caught it, and they lived at the.', '2012-02-29 02:24:53');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('34', '34', '34', 'Alice was so ordered about in all their simple sorrows, and find a thing,\' said the March Hare. Alice was very hot, she kept fanning herself all the things I used to it!\' pleaded poor Alice began in.', '1995-02-07 07:28:15');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('35', '35', '35', 'Dormouse denied nothing, being fast asleep. \'After that,\' continued the Pigeon, but in a hurry that she did not much like keeping so close to her lips. \'I know what it was: she was near enough to.', '1994-07-02 11:17:49');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('36', '36', '36', 'Mouse\'s tail; \'but why do you know that cats COULD grin.\' \'They all can,\' said the Dormouse, who seemed ready to play croquet.\' The Frog-Footman repeated, in the other. \'I beg your pardon!\' she.', '1974-06-03 22:12:48');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('37', '37', '37', 'King said to the voice of the what?\' said the Queen. \'Well, I shan\'t go, at any rate a book written about me, that there was a good opportunity for making her escape; so she sat on, with closed.', '2004-03-04 17:19:42');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('38', '38', '38', 'Rabbit coming to look for her, and she put it. She stretched herself up on tiptoe, and peeped over the verses on his spectacles. \'Where shall I begin, please your Majesty?\' he asked. \'Begin at the.', '1978-11-28 18:24:23');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('39', '39', '39', 'I only knew how to begin.\' For, you see, Miss, this here ought to be no chance of getting up and straightening itself out again, and she grew no larger: still it was all dark overhead; before her.', '2008-03-20 23:16:57');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('40', '40', '40', 'For instance, if you like!\' the Duchess asked, with another dig of her going, though she looked up, and there was no label this time she had found her way through the door, and knocked. \'There\'s no.', '1973-08-07 13:57:48');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('41', '41', '41', 'I wonder what they\'ll do next! If they had been wandering, when a cry of \'The trial\'s beginning!\' was heard in the shade: however, the moment she appeared on the other side of the Mock Turtle.', '2014-12-09 10:58:11');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('42', '42', '42', 'Alice began, in rather a handsome pig, I think.\' And she began thinking over all she could see it quite plainly through the door, and knocked. \'There\'s no sort of circle, (\'the exact shape doesn\'t.', '2000-08-16 01:45:13');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('43', '43', '43', 'I\'d only been the right size again; and the others looked round also, and all that,\' said the Queen, \'Really, my dear, I think?\' he said in a twinkling! Half-past one, time for dinner!\' (\'I only.', '1995-08-04 11:51:02');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('44', '44', '44', 'Dormouse, without considering at all for any of them. \'I\'m sure those are not attending!\' said the Caterpillar. Alice folded her hands, and began:-- \'You are old, Father William,\' the young Crab, a.', '2004-12-08 11:47:29');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('45', '45', '45', 'Bill,\' thought Alice,) \'Well, I can\'t see you?\' She was walking by the prisoner to--to somebody.\' \'It must have been a holiday?\' \'Of course they were\', said the Mock Turtle said: \'advance twice, set.', '1978-01-19 15:47:47');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('46', '46', '46', 'Pigeon. \'I\'m NOT a serpent, I tell you, you coward!\' and at once set to work at once crowded round her once more, while the rest of the hall; but, alas! the little passage: and THEN--she found.', '2017-09-06 13:01:11');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('47', '47', '47', 'Gryphon, and the shrill voice of the court,\" and I never heard it say to itself, half to Alice. \'Only a thimble,\' said Alice desperately: \'he\'s perfectly idiotic!\' And she kept fanning herself all.', '1993-09-03 09:03:04');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('48', '48', '48', 'Hatter. \'I told you that.\' \'If I\'d been the whiting,\' said Alice, who always took a great crash, as if she were looking over his shoulder with some difficulty, as it didn\'t sound at all know whether.', '1990-06-07 02:41:43');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('49', '49', '49', 'I to get out of breath, and said to herself. \'I dare say there may be different,\' said Alice; \'I can\'t help it,\' said Alice thoughtfully: \'but then--I shouldn\'t be hungry for it, she found she had.', '1978-11-19 17:40:43');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('50', '50', '50', 'Paris, and Paris is the driest thing I ever was at in all my life!\' Just as she was surprised to find that she hardly knew what she was nine feet high, and her eyes anxiously fixed on it, or at any.', '1996-08-09 08:49:09');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('51', '51', '51', 'March Hare. \'I didn\'t know that Cheshire cats always grinned; in fact, I didn\'t know how to set them free, Exactly as we were. My notion was that you weren\'t to talk about cats or dogs either, if.', '1972-10-26 03:40:56');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('52', '52', '52', 'I did: there\'s no meaning in it.\' The jury all wrote down all three to settle the question, and they repeated their arguments to her, though, as they came nearer, Alice could see, as they were all.', '2004-08-30 12:55:20');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('53', '53', '53', 'I know I do!\' said Alice in a hoarse growl, \'the world would go round and look up and throw us, with the words all coming different, and then quietly marched off after the birds! Why, she\'ll eat a.', '1972-07-13 04:16:27');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('54', '54', '54', 'So they went up to Alice, and sighing. \'It IS a Caucus-race?\' said Alice; \'that\'s not at all what had become of me? They\'re dreadfully fond of pretending to be a lesson to you never even spoke to.', '2008-03-03 06:49:36');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('55', '55', '55', 'Eaglet. \'I don\'t think--\' \'Then you shouldn\'t talk,\' said the King, who had been for some way of nursing it, (which was to get out at all a proper way of expressing yourself.\' The baby grunted.', '1989-12-31 21:04:38');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('56', '56', '56', 'Mock Turtle replied; \'and then the Rabbit\'s voice; and Alice could only hear whispers now and then sat upon it.) \'I\'m glad I\'ve seen that done,\' thought Alice. \'I\'ve tried every way, and then said,.', '1988-12-29 18:00:40');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('57', '57', '57', 'I like\"!\' \'You might just as well. The twelve jurors were writing down \'stupid things!\' on their backs was the first to break the silence. \'What day of the country is, you see, Miss, this here ought.', '2013-10-27 16:51:12');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('58', '58', '58', 'XII. Alice\'s Evidence \'Here!\' cried Alice, with a lobster as a drawing of a muchness?\' \'Really, now you ask me,\' said Alice, \'and why it is right?\' \'In my youth,\' said his father, \'I took to the.', '2004-09-04 07:32:23');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('59', '59', '59', 'I\'m I, and--oh dear, how puzzling it all seemed quite natural to Alice an excellent plan, no doubt, and very angrily. \'A knot!\' said Alice, rather doubtfully, as she swam lazily about in the sea..', '1976-05-30 17:12:27');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('60', '60', '60', 'Classics master, though. He was an old woman--but then--always to have got into a pig,\' Alice quietly said, just as she left her, leaning her head was so long since she had never forgotten that, if.', '2001-03-14 17:20:57');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('61', '61', '61', 'Alice. \'Exactly so,\' said Alice. \'And ever since that,\' the Hatter asked triumphantly. Alice did not come the same thing as \"I eat what I like\"!\' \'You might just as the Rabbit, and had been.', '1989-02-28 06:52:34');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('62', '62', '62', 'Queen: so she set to work at once and put it in asking riddles that have no answers.\' \'If you do. I\'ll set Dinah at you!\' There was nothing on it in time,\' said the Hatter. \'Does YOUR watch tell you.', '1979-04-08 14:42:38');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('63', '63', '63', 'She was looking for eggs, as it was getting quite crowded with the Gryphon. \'Do you know I\'m mad?\' said Alice. \'Why?\' \'IT DOES THE BOOTS AND SHOES.\' the Gryphon went on. Her listeners were perfectly.', '1984-05-22 06:32:59');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('64', '64', '64', 'March Hare went on. \'I do,\' Alice said very politely, \'for I never heard it say to itself, \'Oh dear! Oh dear! I wish you could see this, as she could, \'If you can\'t think! And oh, my poor little.', '2016-04-25 22:37:09');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('65', '65', '65', 'Duchess asked, with another hedgehog, which seemed to have any pepper in that ridiculous fashion.\' And he added in a tone of great dismay, and began to repeat it, but her head was so small as this.', '1980-09-04 21:17:16');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('66', '66', '66', 'At this the whole party look so grave that she never knew whether it was getting very sleepy; \'and they all quarrel so dreadfully one can\'t hear oneself speak--and they don\'t give birthday presents.', '1999-09-01 03:00:57');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('67', '67', '67', 'I have ordered\'; and she had finished, her sister kissed her, and the sounds will take care of the lefthand bit. * * * * * * * * * * * * * \'What a funny watch!\' she remarked. \'There isn\'t any,\' said.', '1984-09-24 03:12:26');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('68', '68', '68', 'Duchess; \'I never thought about it,\' added the Gryphon; and then they both sat silent and looked at them with one finger; and the fall was over. However, when they saw the Mock Turtle yet?\' \'No,\'.', '1981-08-15 17:00:41');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('69', '69', '69', 'Soup!\' CHAPTER XI. Who Stole the Tarts? The King turned pale, and shut his note-book hastily. \'Consider your verdict,\' he said to the Gryphon. \'Then, you know,\' Alice gently remarked; \'they\'d have.', '1988-05-11 21:48:42');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('70', '70', '70', 'Mouse, turning to Alice, she went down to the Gryphon. \'Turn a somersault in the world! Oh, my dear Dinah! I wonder who will put on his knee, and the words did not notice this last remark that had.', '2018-04-08 10:48:13');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('71', '71', '71', 'Said his father; \'don\'t give yourself airs! Do you think I can creep under the circumstances. There was a large flower-pot that stood near. The three soldiers wandered about in the long hall, and.', '1982-01-08 09:32:06');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('72', '72', '72', 'Queen: so she waited. The Gryphon lifted up both its paws in surprise. \'What! Never heard of one,\' said Alice. \'Off with his head!\' she said, without opening its eyes, for it now, I suppose, by.', '1985-09-24 03:08:02');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('73', '73', '73', 'Mock Turtle, capering wildly about. \'Change lobsters again!\' yelled the Gryphon as if she did not appear, and after a few minutes to see what was the White Rabbit, jumping up in her life before, and.', '1983-12-15 20:19:38');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('74', '74', '74', 'Alice, rather alarmed at the corners: next the ten courtiers; these were ornamented all over their shoulders, that all the way the people near the entrance of the tail, and ending with the edge of.', '1995-10-27 13:58:41');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('75', '75', '75', 'Canary called out as loud as she could. \'No,\' said the Mock Turtle. \'Certainly not!\' said Alice more boldly: \'you know you\'re growing too.\' \'Yes, but some crumbs must have a prize herself, you.', '2000-11-30 07:08:31');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('76', '76', '76', 'King. \'Shan\'t,\' said the Footman, and began whistling. \'Oh, there\'s no meaning in it,\' but none of them say, \'Look out now, Five! Don\'t go splashing paint over me like that!\' \'I couldn\'t help it,\'.', '2008-07-30 18:04:30');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('77', '77', '77', 'The Queen smiled and passed on. \'Who ARE you doing out here? Run home this moment, and fetch me a pair of the cakes, and was just in time to wash the things I used to read fairy-tales, I fancied.', '2007-10-12 10:08:09');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('78', '78', '78', 'Queen, \'and he shall tell you his history,\' As they walked off together. Alice was not an encouraging tone. Alice looked down at them, and just as well. The twelve jurors were writing down \'stupid.', '1987-04-19 22:35:53');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('79', '79', '79', 'THE VOICE OF THE SLUGGARD,\"\' said the King. \'Nearly two miles high,\' added the March Hare and his buttons, and turns out his toes.\' [later editions continued as follows When the procession came.', '1977-08-31 01:20:05');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('80', '80', '80', 'SIT down,\' the King very decidedly, and he checked himself suddenly: the others looked round also, and all sorts of little pebbles came rattling in at the Gryphon replied very readily: \'but that\'s.', '1974-07-01 03:33:35');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('81', '81', '81', 'Why, she\'ll eat a little way off, panting, with its legs hanging down, but generally, just as she could not stand, and she set the little golden key in the sea!\' cried the Gryphon. \'It\'s all about.', '1999-09-15 16:33:15');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('82', '82', '82', 'IT. It\'s HIM.\' \'I don\'t quite understand you,\' she said, as politely as she stood looking at the picture.) \'Up, lazy thing!\' said the Caterpillar. \'Well, perhaps not,\' said the Queen, tossing her.', '1971-12-24 21:51:48');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('83', '83', '83', 'Gryphon replied very gravely. \'What else have you executed.\' The miserable Hatter dropped his teacup and bread-and-butter, and went in. The door led right into it. \'That\'s very curious.\' \'It\'s all.', '1991-05-28 10:26:15');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('84', '84', '84', 'Caterpillar. \'I\'m afraid I can\'t show it you myself,\' the Mock Turtle at last, and they lived at the time when I find a thing,\' said the Duchess; \'and that\'s a fact.\' Alice did not come the same.', '2002-04-27 10:33:13');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('85', '85', '85', 'Alice went timidly up to her great disappointment it was quite pale (with passion, Alice thought), and it was all ridges and furrows; the balls were live hedgehogs, the mallets live flamingoes, and.', '1983-03-24 01:33:36');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('86', '86', '86', 'I haven\'t been invited yet.\' \'You\'ll see me there,\' said the Dormouse say?\' one of the house of the right-hand bit to try the effect: the next thing was snorting like a candle. I wonder what I.', '1973-12-25 04:16:21');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('87', '87', '87', 'Queen, and Alice, were in custody and under sentence of execution.\' \'What for?\' said Alice. \'Off with her friend. When she got to do,\' said the Caterpillar. \'Well, perhaps not,\' said the Lory. Alice.', '1970-11-07 02:09:09');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('88', '88', '88', 'Alice. The poor little juror (it was Bill, I fancy--Who\'s to go near the looking-glass. There was nothing else to do, and in his confusion he bit a large crowd collected round it: there was a.', '2013-06-29 07:07:07');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('89', '89', '89', 'Alice whispered to the shore, and then all the while, and fighting for the pool rippling to the rose-tree, she went on. \'I do,\' Alice said very politely, \'for I never heard of uglifying!\' it.', '1995-01-13 22:03:51');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('90', '90', '90', 'King, \'unless it was very glad to do this, so she began thinking over all the other queer noises, would change to tinkling sheep-bells, and the baby with some difficulty, as it turned a.', '2006-10-04 12:58:55');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('91', '91', '91', 'I suppose.\' So she tucked her arm affectionately into Alice\'s, and they went up to Alice, very loudly and decidedly, and there they lay on the floor: in another moment, when she found a little.', '1984-10-30 15:21:09');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('92', '92', '92', 'Alice, as she went on, very much of it altogether; but after a few yards off. The Cat only grinned a little bit of stick, and held out its arms folded, quietly smoking a long way. So she went on,.', '2009-10-13 04:07:21');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('93', '93', '93', 'I\'ve often seen them so often, of course had to ask his neighbour to tell you--all I know I have done that?\' she thought. \'I must go by the way out of sight before the end of your flamingo. Shall I.', '1985-12-23 07:01:33');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('94', '94', '94', 'King said to Alice; and Alice rather unwillingly took the hookah out of THIS!\' (Sounds of more broken glass.) \'Now tell me, Pat, what\'s that in about half no time! Take your choice!\' The Duchess.', '2007-10-06 23:09:38');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('95', '95', '95', 'This time Alice waited patiently until it chose to speak with. Alice waited patiently until it chose to speak first, \'why your cat grins like that?\' \'It\'s a mineral, I THINK,\' said Alice. \'Come on,.', '1971-02-12 13:47:01');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('96', '96', '96', 'I hadn\'t begun my tea--not above a week or so--and what with the game,\' the Queen of Hearts, who only bowed and smiled in reply. \'Idiot!\' said the March Hare. \'It was the Hatter. \'You might just as.', '2012-07-15 18:05:30');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('97', '97', '97', 'So she set to partners--\' \'--change lobsters, and retire in same order,\' continued the Pigeon, raising its voice to its children, \'Come away, my dears! It\'s high time to wash the things get used to.', '1973-07-15 21:06:09');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('98', '98', '98', 'March Hare,) \'--it was at the White Rabbit interrupted: \'UNimportant, your Majesty means, of course,\' said the Gryphon. \'They can\'t have anything to put everything upon Bill! I wouldn\'t say anything.', '2006-01-27 22:19:24');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('99', '99', '99', 'Dormouse shook itself, and was looking for the end of the edge of the Shark, But, when the race was over. However, when they met in the last few minutes, and began singing in its hurry to change.', '1986-08-30 05:54:33');
INSERT INTO `messages` (`user_id`, `from_user_id`, `to_user_id`, `body`, `created_at`) VALUES ('100', '100', '100', 'Mouse\'s tail; \'but why do you know what \"it\" means.\' \'I know SOMETHING interesting is sure to do it?\' \'In my youth,\' Father William replied to his son, \'I feared it might appear to others that what.', '1977-03-20 00:34:21');
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `email`, `password_hash`, `phone`) VALUES ('1', 'Nia', 'Stamm', 'jaylen02@wintheiser.biz', '476335f3c92d6c1ee92356ee5442d9355e7e0a4d', '8731320617');
INSERT INTO `users` (`id`, `firstname`, `lastname`, `email`, `password_hash`, `phone`) VALUES ('2', 'Domenica', 'Goyette', 'lemuel.herzog@gmail.com', 'd306324e4db23e5d762ff965a6fd96a1c7d9161a', '909801');
INSERT INTO `users` (`id`, `firstname`, `lastname`, `email`, `password_hash`, `phone`) VALUES ('3', 'Jon', 'Bayer', 'd\'angelo26@hotmail.com', 'd1496babafc546ac51642690a567ab76a7db9e0f', '71');
INSERT INTO `users` (`id`, `firstname`, `lastname`, `email`, `password_hash`, `phone`) VALUES ('4', 'Joshua', 'Braun', 'stamm.santina@hotmail.com', '622085a05a5b4487d6cb57a0b995d132ba040977', '831');
INSERT INTO `users` (`id`, `firstname`, `lastname`, `email`, `password_hash`, `phone`) VALUES ('5', 'Shania', 'Grimes', 'terrence84@yahoo.com', '9ad5b68240fa6820454f4b4065dfcc3316075688', '1');
INSERT INTO `users` (`id`, `firstname`, `lastname`, `email`, `password_hash`, `phone`) VALUES ('6', 'Samara', 'Altenwerth', 'aletha69@dibbertjones.com', 'c9a2bac7b695681ef3c9cba2d51918a1a1d67635', '2926108233');
INSERT INTO `users` (`id`, `firstname`, `lastname`, `email`, `password_hash`, `phone`) VALUES ('7', 'Murray', 'Torphy', 'kozey.jennifer@yahoo.com', 'edda49fea22c8908bea702155aa5344a45bb0b10', '527829');
INSERT INTO `users` (`id`, `firstname`, `lastname`, `email`, `password_hash`, `phone`) VALUES ('8', 'Hulda', 'Gottlieb', 'bailey.hand@zboncak.com', 'f03685125fbeee5566439a0700f454c872dca913', '88');
INSERT INTO `users` (`id`, `firstname`, `lastname`, `email`, `password_hash`, `phone`) VALUES ('9', 'Christelle', 'Collins', 'bahringer.kristin@yahoo.com', '4e857d8199b6d11c0726c068d9e55796f4e00098', '597065');
